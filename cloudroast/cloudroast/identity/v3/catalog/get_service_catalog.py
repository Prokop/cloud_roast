...
class TestCatalog(IdentityV3Fixture):
    ...
    def test_get_service_catalog(self):
        ...
        resp = self.project_composite.apis.catalog.client.get_catalog()
        ...
        self.assertEqual("{0}/auth/catalog".format(
            self.project_composite.ident_config.global_authentication_endpoint),
    ...
    def test_list_users(self):
        ...
        resp = self.project_composite.apis.users.client.list_users()
