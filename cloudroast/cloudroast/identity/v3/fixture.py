...
from cloudcafe.identity.v3.composites import (
    ProjectIdentityV3Composite, DomainIdentityV3Composite)
...
class IdentityV3Fixture(BaseTestFixture):
    ...
    def setUpClass(cls):
        ...
        cls.project_composite = ProjectIdentityV3Composite(cls.user_config)
        cls.domain_composite = DomainIdentityV3Composite(cls.user_config)
