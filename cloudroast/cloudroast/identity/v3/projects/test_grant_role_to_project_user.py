...
class TestGrantRoleToProjectUser(IdentityV3Fixture):
    ...
    def tearDown(self):
        ...
        super(TestGrantRoleToProjectUser, self).tearDown()

    def test_grant_role_to_project_user_using_domain_scoped_token(self):
    ...
    def test_grant_role_to_project_user_using_project_scoped_token(self):
        composite = self.project_composite
        response = composite.apis.roles.client.grant_role_to_project_user(
            project_id=composite.user_config.project_id,
            user_id=composite.ident_config.user_for_test_roles,
