...
class TestGrantRoleToProjectGroup(IdentityV3Fixture):
    ...
    def tearDown(self):
        ...
        super(TestGrantRoleToProjectGroup, self).tearDown()

    def test_grant_role_to_project_group_using_domain_scoped_token(self):
    ...
    def test_grant_role_to_project_group_using_project_scoped_token(self):
        composite = self.project_composite
        response = composite.apis.roles.client.grant_role_to_project_group(
            project_id=composite.user_config.project_id,
            group_id=composite.ident_config.group_for_test_roles,
