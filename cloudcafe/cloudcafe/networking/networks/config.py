...
class ContrailConfig(ConfigSectionInterface):

    SECTION_NAME = 'contrail'

    @property
    def api_server_ip(self):
        return self.get("api_server_ip")

    @property
    def fabric_service_ip(self):
        return self.get("fabric_service_ip")

    @property
    def fabric_service_port(self):
        return self.get("fabric_service_port", 80)

    @property
    def fabric_service_name(self):
        return self.get("fabric_service_name")
