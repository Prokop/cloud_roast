...
class IdentityConfig(ConfigSectionInterface):
    ...
    @property
    def role_for_grant_id(self):
        return self.get("role_for_grant_id")

    @property
    def role_for_grant_name(self):
        return self.get("role_for_grant_name")

    @property
    def user_for_test_roles(self):
        return self.get("user_for_test_roles")

    @property
    def group_for_test_roles(self):
        return self.get("group_for_test_roles")
...
class IdentityUserConfig(ConfigSectionInterface):
    ...
    def scope_project_id(self):
        return self.get("scope_project_id")

    @property
    def scope_domain_id(self):
        return self.get("scope_domain_id")
    ...
    def user_domain_name(self):
        return self.get("user_domain_name")
